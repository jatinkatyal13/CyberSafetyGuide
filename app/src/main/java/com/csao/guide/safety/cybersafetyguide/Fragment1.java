...
public class Fragment1 extends Fragment {
    ...
    private List<String> getJson(String fileName){
        ...
        try {
            ...
            List<String> list = new ArrayList<>();
            String JsonText = "{\"info\":[\"Do not give out identifying information such as Name, Home address, School Name or Telephone Number in a chat room.\",\"Do not send your photograph to anyone on the Net without first checking with your parents or guardians. \"]}";
            try {
                JSONObject jsonObject = new JSONObject(JsonText);
                JSONArray data = jsonObject.getJSONArray("info");
                for (int i=0; i<data.length(); i++){
